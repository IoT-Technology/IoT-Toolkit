 ...
 * @author mushuwei
 */
public class LwM2MShareKeyNode implements TkNode {
    ...
    public String nodePrompt() {
        return bundle.getString(NbSettingsCodeEnum.NB_LWM2M_PSK_SHARE_KEY.getCode() + GlobalConstants.promptSuffix) +
