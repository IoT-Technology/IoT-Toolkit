...
public class LwM2MDtlsNode implements TkNode {
    ...
    public void prePrompt(NodeContext context) {
        System.out.format(ColorUtils.greenItalic(bundle.getString(NbSettingsCodeEnum.NB_LWM2M_DTLS.getCode() + GlobalConstants.prePrompt)) + "%n");
    ...
    public String nodePrompt() {
        return bundle.getString(NbSettingsCodeEnum.NB_LWM2M_DTLS.getCode() + GlobalConstants.promptSuffix) +
    ...
    public String nextNode(NodeContext context) {
        ...
        if (context.getData().equals(ConfirmCodeEnum.NO.getValue())) {
