...
public class NbDescribeCommand implements Callable<Integer> {
	...
	public Integer call() throws Exception {
		...
		System.out.format("" + "%n");
		System.out.format(
				CommandLine.Help.Ansi.AUTO.string("@|fg(Cyan),italic " + "官方地址: " + "https://omaspecworks.org/" + "|@") + "%n");
		System.out.format(CommandLine.Help.Ansi.AUTO.string("@|fg(Cyan),italic " + "版本协议文档: "
