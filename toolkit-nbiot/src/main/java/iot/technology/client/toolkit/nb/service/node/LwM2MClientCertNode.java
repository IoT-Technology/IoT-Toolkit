 ...
 * @author mushuwei
 */
public class LwM2MClientCertNode implements TkNode {

    ResourceBundle bundle = ResourceBundle.getBundle(StorageConstants.LANG_MESSAGES);

    @Override
    public void prePrompt(NodeContext context) {
        System.out.format(ColorUtils.greenItalic(bundle.getString(NbSettingsCodeEnum.NB_LWM2M_CLIENT_CERT.getCode() + GlobalConstants.prePrompt)) + "%n");
    }
    ...
    public String nodePrompt() {
        return bundle.getString(NbSettingsCodeEnum.NB_LWM2M_CLIENT_CERT.getCode() + GlobalConstants.promptSuffix) +
